    ...
    //表面を開く
    function omoteOpen(){
      $("#card li:eq("+index+") img").attr("src","img/card"+cat[index]+".png").addClass("front");
      $("#card li:eq("+index+") img").stop().animate({ width: "175px",height: "260px"}, speed);
      $("#card li:eq("+index+")").stop().animate({ left: "0"}, speed);
    }
    //裏面を開く
    function uraOpen(j){
      $("#card li:eq("+j+") img").attr("src","img/card.png");
      $("#card li:eq("+j+") img").stop().animate({ width: "175px",height: "260px"}, speed);
    ...
    $(function(){
      ...
      $("#bg_black").click(function(){
        $("#bg_black").hide();
        $("#card li img.front").addClass("resize");
      })
    });